...
export const generateGoogleCalendarUrl = (call: IntroCallBooking): string => {
  ...
  return `https://calendar.google.com/calendar/render?action=TEMPLATE&text=${title}&dates=${datesStr}&details=${detailsStr}&location=${locationStr}&add=${guestEmail}&authuser=info@nativebooking.co`
}
