    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <span className="aave-header-logo-text" style={{ fontSize: '18px', fontWeight: 800, letterSpacing: '-0.02em', color: '#ffffff' }}>
            NATIVEBOOKING
          </span>
        </div>
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '900px', margin: '0 auto', width: '100%' }}>
          ...
          {/* Action Buttons */}
          <div className="aave-hero-buttons" style={{ display: 'flex', gap: '14px', justifyContent: 'center', marginBottom: '60px', flexWrap: 'wrap' }}>
          ...
          <div id="workbench" style={{ position: 'relative', zIndex: 2, width: '100%' }}>
            <InteractiveShowcase />
          </div>
        </div>
      </section>
