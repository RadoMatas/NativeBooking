        ...
        >
          ...
          >
            <h2 style={{ fontSize: '24px', marginBottom: '8px', color: 'var(--accent-color)' }}>
              Vanguard Academy Course Seat Reservation
            </h2>
            <p style={{ color: 'var(--text-secondary)', fontSize: '13px', marginBottom: '16px', lineHeight: '1.5' }}>
              Confirm your seat in the course cohort. 10% enrollment deposit reserves your seat and grants immediate access to pre-requisite Discord study materials.
            </p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group" style={{ marginBottom: '24px' }}>
            ...
            {!date || dateError ? (
              ...
              >
                Please pick a valid preferred date above to inspect instructor class schedule.
              </div>
            ) : generateTimeSlots().length === 0 ? (
              <div style={{ color: '#f87171', fontSize: '13px' }}>No class hours configured for this day.</div>
            ) : (
              <div
                style={{
                  display: 'grid',
                ...
                {generateTimeSlots().map((slot) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        {isSelected ? '✓ Selected' : isAvailable ? 'Open Seat' : 'Full'}
                      </div>
                    </button>
                  )
                })}
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              placeholder="Describe your technical background, programming experience, or specific course learning goals..."
